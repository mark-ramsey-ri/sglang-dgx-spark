...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# SGLang Cluster Shutdown Script
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# Stops SGLang containers on head and all worker nodes.
...
# Stop all sglang-* containers on remote node
CONTAINERS=$(docker ps -a --format '{{.Names}}' | grep -E "^sglang-" || true)
if [ -n "${CONTAINERS}" ]; then
  ...
  echo "    No SGLang containers found"
fi
REMOTE_EOF
}
...
LOCAL_CONTAINERS=$(docker ps --format '{{.Names}}' | grep -E "^sglang-" || true)

if [ -z "${LOCAL_CONTAINERS}" ]; then
  log "No SGLang containers on head node."
else
...
# Stop any other sglang-* containers
for c in $(docker ps --format '{{.Names}}' | grep -E "^sglang-" || true); do
  if stop_local_container "${c}"; then
    STOPPED=$((STOPPED + 1))
  fi
done
